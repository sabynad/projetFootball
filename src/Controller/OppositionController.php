...
class OppositionController extends AbstractController
{
    ...
    // Matchs joués
    #[Route('/match/{id}', name: 'app_match_show', methods: ['GET'])]
    public function match_show(Opposition $opposition): Response
    {
        return $this->render('opposition/match.html.twig', [
            'opposition' => $opposition,
        ]);
    }
    ...
    {
        if ($this->isCsrfTokenValid('delete'.$opposition->getId(), $request->request->get('_token'))) {
